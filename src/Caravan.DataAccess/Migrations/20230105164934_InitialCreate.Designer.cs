...
namespace Caravan.DataAccess.Migrations
{
    ...
    [Migration("20230105164934_InitialCreate")]
            ...
            modelBuilder.Entity("Caravan.Domain.Entities.Administrator", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 1, 5, 16, 49, 34, 111, DateTimeKind.Utc).AddTicks(2176),
                            ...
                            UpdatedAt = new DateTime(2023, 1, 5, 16, 49, 34, 111, DateTimeKind.Utc).AddTicks(2180)
                        });
                });
