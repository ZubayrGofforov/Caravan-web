...
namespace Caravan.DataAccess.Migrations
{
    ...
    [Migration("20230207195529_AdminRoleCreate")]
    partial class AdminRoleCreate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Caravan.Domain.Entities.Administrator", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 2, 7, 19, 55, 28, 744, DateTimeKind.Utc).AddTicks(7306),
                            ...
                            UpdatedAt = new DateTime(2023, 2, 7, 19, 55, 28, 744, DateTimeKind.Utc).AddTicks(7310)
                        });
                });
            ...
            modelBuilder.Entity("Caravan.Domain.Entities.Order", b =>
                {
                    b.HasOne("Caravan.Domain.Common.Location", "DeliveryLocation")
                        .WithMany()
